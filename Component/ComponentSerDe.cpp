...
void ComponentSerDe::Save(std::unordered_map<TypeID, IComponent*>& components, std::string filename)
{
...
void ComponentSerDe::Load(std::unordered_map<TypeID, IComponent*>& components, std::string filename)
{
